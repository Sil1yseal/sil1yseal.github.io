...
|constant      | A fixed value that cannot change once set. | `const PI = 3.14;` |going on forever |  |
|Data type      | The kind of value a variable holds, like numbers or text. | `int`, `String`, `bool` |so it can seperate the information  |  |
|String      | A sequence of characters used to represent words or text. | `"Hello World"` |Letters and numbers being used in a sentenc like this one   |  |
|Integer      | Whole number values. | `int age = 16;` |  |  |
|Diuble      | Number values with decimals. | `double age = 16.2;` |  |  |
